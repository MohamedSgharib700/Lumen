...
class PortfolioController extends Controller {
    ...
    public function __construct(Requests\PortfolioRequest $request, Portfolio $model) {
            ...
            if ($this->request->hasFile('gallary')) {
                ...
                foreach ($gallary as $photo) {
                    ...
                    if ($extension == "jpg" || $extension == "jpeg" || $extension == "png" || $extension == "gif") {
                        $galary = new PortfolioGalary();
                        $galary->photo = $name;
                        $galary->portfolio_id = $insert->id;
                        $galary->save();
                        $dest = 'admin-assets/images/portfolio/';
    ...
    public function delgal($id) {
        ...
        $image = 'admin-assets/images/portfolio/' . $photo->photo;
