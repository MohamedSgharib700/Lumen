...
class SubCatController extends Controller {
    ...
    public function __construct(CategoryRequest $request, SubCat $model) {
    ...
    public function create() {
        ...
        $cats = Category::all()->lists('name', 'id');
    ...
    public function update($id) {
        ...
        if ($update) {
            if ($this->request->ajax())
                return response()->json(array('status' => 'true', 'message' => 'Update Category Done'));
