...
class BlogController extends Controller {
    ...
    public function create() {
        ...
        return View($this->view . 'create', compact('cats','users'));
    }
    ...
    public function show($id) {
        ...
        return View($this->view . 'show', compact('blog'));
    }
    ...
    public function edit($id) {
        ...
        if ($blog) {
            return View($this->view . 'edit', compact('blog', 'cats','users'));
        } else {
            abort(404);
        }
    }
    ...
    public function delgal($id) {
        ...
        $image = 'admin-assets/images/blogs/' . $photo->photo;
