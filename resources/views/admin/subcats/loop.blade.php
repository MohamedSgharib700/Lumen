...
<tr id="trow_{{ $row->id }}">
    ...
    <td>
        <a class="btn btn-default btn-rounded btn-sm waves-effect waves-light btn modal-trigger" href={{ url('admin/subcats/'.$row->id.'/edit')}} ><span class="fa fa-pencil"></span></a>
