...
@section('content')
 <a class="btn-floating btn-large waves-effect waves-light red " href="{{ url('admin/portfolio/create')}}"><i class="material-icons">add</i></a>
