    ...
    <main id="main" role="main">
        ...
        <section class="port-single padding-top-100">
            <div class="container">
                ...
                <!-- beans-slider -->
                <div class="beans-slider" data-rotate="true" style="
    left: 25%;
">
                    <div class="beans-mask">
                        <div class="beans-slideset" style="width: 600px; height: 400px;">
                            <!-- beans-slide -->
                            @foreach($spec_proj->galary as $galary)
                            <div  class="beans-slide" style="width: 600px; height: 400px;">
                                <div class="stretch" style="width: 600px; height: 400px;">

                                    <img style="width: 600px; height: 400px;" src="{{asset('admin-assets/images/projects/'.$galary->photo)}}" alt="image description">
                                </div>
                            </div>
                            @endforeach
                            <!-- beans-slide -->
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <ul>
                            ...
                            <li>
                                <i class="fa fa-tags"></i> <strong>{{trans('lang.category')}}:</strong> <a @if (Session::get('local') == 'ar') href="{{URL($spec_proj->sub_cat->cat->ar_custom_url.'/'. $spec_proj->sub_cat->ar_custom_url) }}"
                                                                                                           @else href="{{URL( $spec_proj->sub_cat->cat->custom_url.'/'.$spec_proj->sub_cat->custom_url) }}" @endif>@if (Session::get('local') == 'ar') {{$spec_proj->sub_cat->ar_name}} @else {{$spec_proj->sub_cat->name}} @endif </a>
